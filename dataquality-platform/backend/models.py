...
class Task(Base):
    ...
    rule_configs: Mapped[dict] = mapped_column(JSON, nullable=True, default=None)
    table_name: Mapped[str] = mapped_column(String(200), nullable=True, default=None)
    sampling: Mapped[dict] = mapped_column(JSON, nullable=True, default=None)
